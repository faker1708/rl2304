...
# with open('./model/cart_pole/1619637.pkl', "rb") as f:
# with open('./model/cart_pole/1608242.pkl', "rb") as f:
# with open('./model/cart_pole/51103.pkl', "rb") as f:    # 稳定
# with open('./model/cart_pole/24471.pkl', "rb") as f:    # 稳定
with open('./model/cart_pole/b.pkl', "rb") as f:
    dqn = pickle.load(f)
    # EPSILON = 0.9
